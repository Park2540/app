...
export default function SetDurian1({ navigation }) {
    ...
    return (
        <View style={globalStyles.container}>
            ...
            <TouchableHighlight style={[styles.items,]}
				...
				onPress={
                    () => navigation.navigate('Soilmoisture1')}
			>
			...
			<TouchableHighlight style={[styles.items,]}
				underlayColor='#00BE00'
				onPress={
                    () => navigation.navigate('Airhumidity1')}
			>
				<View style={styles.viewImgTextContainer}>
            ...
            <TouchableHighlight style={[styles.items,]}
				underlayColor='#00BE00'
				onPress={
                    () => navigation.navigate('Soiltemperature1')}
			>
				<View style={styles.viewImgTextContainer}>
            ...
            <TouchableHighlight style={[styles.items,]}
				underlayColor='#00BE00'
				onPress={
                    () => navigation.navigate('Airtemperature1')}
			>
				<View style={styles.viewImgTextContainer}>
			...
			<TouchableHighlight style={[styles.items,]}
				underlayColor='#00BE00'
				onPress={
                    () => navigation.navigate('Lightneedles1')}
			>
				<View style={styles.viewImgTextContainer}>
