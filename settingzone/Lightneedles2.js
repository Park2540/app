...
export default function Lightneedles2({ route, navigation }){
        ...
        <View >
            ...
            <TouchableHighlight  style={ SettingStyles.items3}>
				...
				<View style={ SettingStyles.container1}>
                    ...
                    <View>
                        <Image source={require('../src/smart-light.png')} style={ SettingStyles.img}/>
                    </View>
            	
					<Text style={ SettingStyles.buttonText3}>ความเข็มแสง</Text>
				</View>
