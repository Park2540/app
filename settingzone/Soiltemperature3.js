...
export default function Soiltemperature3({ route, navigation }){
        ...
        <View >
            ...
            <TouchableHighlight  style={ SettingStyles.items3}>
				...
				<View style={ SettingStyles.container1}>
                    ...
                    <View>
                        <Image source={require('../src/temperature.png')} style={ SettingStyles.img}/>
                    </View>
            	
					<Text style={ SettingStyles.buttonText3}>อุณหภูมิดิน</Text>
				</View>
