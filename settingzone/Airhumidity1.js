...
export default function Airhumidity1({ route, navigation }){
        ...
        <View >
            ...
            <TouchableHighlight  style={ SettingStyles.items3}>
				...
				<View style={ SettingStyles.container1}>
                    ...
                    <View>
                        <Image source={require('../src/humidity.png')} style={ SettingStyles.img}/>
                    </View>
            	
					<Text style={ SettingStyles.buttonText3}>ความชื้นอากาศ</Text>
				</View>
